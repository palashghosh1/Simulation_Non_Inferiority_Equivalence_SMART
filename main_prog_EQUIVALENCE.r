  ...
  #   title: "Simulation for Equivalence test for SMART"
  ...
  # for Equivalence: added 6 March 18
  
  # Distinct-path:
  # Here "for_delta" is irrevant:
  
  
  out[1,] <- main_func(1, 4, 2,  0.50,  0.50, 0.05, 0.2, 1)
  out[2,] <- main_func(2, 4, 2,  0.45,  0.45, 0.05, 0.2, 1)
  out[3,] <- main_func(3, 4, 2,  0.40,  0.40, 0.05, 0.2, 1)
  out[4,] <- main_func(4, 4, 2,  0.35,  0.35, 0.05, 0.2, 1)
  out[5,] <- main_func(5, 4, 2,  0.30,  0.30, 0.05, 0.2, 1)
  
 
  # Shared-path:
  
  out[26,] <- main_func(26, 4, 2,  0.50,  0.50, 0.05, 0.2, 1)
  out[27,] <- main_func(27, 4, 2,  0.45,  0.45, 0.05, 0.2, 1)
  out[28,] <- main_func(28, 4, 2,  0.40,  0.40, 0.05, 0.2, 1)
  out[29,] <- main_func(29, 4, 2,  0.35,  0.35, 0.05, 0.2, 1)
  out[30,] <- main_func(30, 4, 2,  0.30,  0.30, 0.05, 0.2, 1)
