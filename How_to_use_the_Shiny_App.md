...
1. Calculate the minimum sample size required for Non-Inferiority test in SMART.

2. Calculate the minimum sample size required for Equivalence test in SMART. 
...
4. Set the the standardized effect size. The default value is 0.3. The Standardized Effect Size = (The standardized Non-Inferiority margin) - (The standardized mean difference). See the 'Non-Inferiority Test' section of the paper given in reference for details.
